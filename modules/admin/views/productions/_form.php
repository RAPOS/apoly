...
<div class="lactions-form">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-3">
			<?= $form->field($model, 'cost')->input('text')?>
		</div>
		<div class="col-xs-12 col-sm-4">
...
<script>
	page = {files_count: 1};
	$('#lproductions-cost').siblings('label').css('display', 'block');
	$('#lproductions-cost').css({'display': 'inline-block', 'width': '70%'});
	$('#lproductions-cost').after('<div style="display: inline-block;margin-left: 5px;"> руб./кг</div>')
</script>