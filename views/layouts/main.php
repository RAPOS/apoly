										...
										<div class="row">
											<div class="col-sm-12 col-md-9 col-md-offset-3">
												...
												<div class="col-sm-12 col-md-8 review_info">
													<p class="review_name">Климова Ирина Сергеевна</p>
													<p class="review_job">Гендиректор компании «ПолимерПромВест»</p>
												</div>
											</div>									
										</div>										
										<p>"Мы сотрудничаем с Аполи в течение трех лет. За этот период компания зарекомендовала себя в качестве надежного партнера, ставящего интересы клиента выше собственных. Индивидуальный подход в решении вопросов, возникающих в процессе сотрудничества, является одним из весомых аргументов в пользу Аполи. Это выгодно отличает компанию среди себе подобных."</p>
									</div>
								</li>
								<li>
									<div>
										<div class="row">
											<div class="col-sm-12 col-md-9 col-md-offset-3">
												...
												<div class="col-sm-12 col-md-8 review_info">
													<p class="review_name">Лодин Иван Алексеевич</p>
													<p class="review_job">Менеджер по снабжению ООО «ЭраГрупп»</p>
												</div>
											</div>									
										</div>										
										<p>"Каждый раз, закупая полипропилен и другое полимерное сырье у компании Аполи, мы точно знаем, что выбранная нами продукция окажется в наличии. Это существенно сокращает период времени, отделяющий момент оформления заказа от момента прибытия товара на территорию предприятия."</p>
									</div>
								</li>	
								<li>
									<div>
										<div class="row">
											<div class="col-sm-12 col-md-9 col-md-offset-3">
												...
												<div class="col-sm-12 col-md-8 review_info">
													<p class="review_name">Ефимов Анатолий Григорьевич</p>
													<p class="review_job">Главный менеджер отдела снабжения НПО «ГранПолимер»</p>
												</div>
											</div>									
										</div>										
										<p>"Наше объединение взаимодействует с компанией Аполи не больше года, что, однако позволило уже сейчас сформировать положительный образ данного поставщика. Товар отгружается своевременно и в полном объеме, задержек в поставках не отмечено. Выборочная проверка качества поставляемого сырья и материалов свидетельствует о полном его соответствии всем требованиям."</p>
									</div>
								</li>								
								<?if(count($LBanners)){
